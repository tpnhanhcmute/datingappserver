...
const like = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (matchQuery.docs.length > 0) {
            ...
            const userRef = yield firebase_service_1.database.collection("user").doc(likeRequest.otherUserID.toString()).get();
            ...
            if (userDoc.deviceToken != null) {
                ...
                firebase_service_1.message.sendEachForMulticast({
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newUser = {};
    try {
        const snapshots = yield userRef.where("email", "==", email).where("isAuth", "==", true).get();
        if (snapshots.empty) {
            ...
            if (snapshot.empty) {
                ...
                yield firebase_service_1.database.collection("user").doc(snapshot.docs[0].id).update({
...
const getUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { userID } = req.body;
    try {
        const [userCollection, imageCollection, locationCollection] = yield Promise.all([firebase_service_1.database.collection("user").doc(userID).get(),
